...
return [
    'exception_message' => '異常資訊: :message',
    'exception_trace' => '異常跟蹤: :trace',
    'exception_message_title' => '異常資訊',
    'exception_trace_title' => '異常跟蹤',
    ...
    'backup_successful_body' => '好訊息, :application_name 備份成功，位於磁碟 :disk_name 中。',
    ...
    'unhealthy_backup_found_empty' => '根本沒有此應用程式的備份。',
    'unhealthy_backup_found_old' => '最近的備份建立于 :date ，太舊了。',
    'unhealthy_backup_found_unknown' => '對不起，確切原因無法確定。',
    'unhealthy_backup_found_full' => '備份佔用了太多儲存空間。目前佔用了 :disk_usage ，高於允許的限制 :disk_limit。',
];
