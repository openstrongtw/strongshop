...
Your order[ <a href="{{route('user.my.order.detail', ['orderId'=>$order->id])}}">{{$order->order_no}}</a> ] has been paid successfully, we will deliver the goods as soon as possible.
