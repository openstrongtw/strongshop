...
<script type="text/html" id="ST-TOOL-BAR">
    <div class="layui-btn-container st-tool-bar">
        <a class="layui-btn layui-btn-xs" href="/strongadmin/region/regionContinent/index">大陸管理</a>
        <a class="layui-btn layui-btn-xs" onclick="Util.createFormWindow('/strongadmin/region/regionCountry/create', this.innerText);">新增</a>
        <a class="layui-btn layui-btn-xs" lay-event="batchDelete" data-href="/strongadmin/region/regionCountry/destroy">刪除選中</a>
    </div>
</script>
<script type="text/html" id="ST-OP-BUTTON">
    @verbatim
    <a class="layui-btn layui-btn-xs" onclick="Util.createFormWindow('/strongadmin/region/regionCountry/update?id={{d.id}}', this.innerText);">更新</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="Util.destroy('/strongadmin/region/regionCountry/destroy?id={{d.id}}');">刪除</a>
    @endverbatim
</script>
@endsection
@push('scripts_bottom')        
...
!function () {
    ...
    var cols = [
                ...
                , {field: 'continent_iso2', title: '大陸名稱', width: 150, templet: function (res) {
